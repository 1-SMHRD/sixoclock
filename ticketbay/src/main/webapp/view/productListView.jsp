	...
	<div class="contentsMenuWrap">
		...
		<!-- //MY티켓베이 대쉬보드 -->
			...
			<div class="boxStyle01 myServiceLnb">
				<ul class="myClass6">
					<li class="nth1 order">
						<a href="javascript:void(0);">내가 구매한 상품</a>
					...
					<li class="nth6 member"><a href="/web/myservice/passwordConfirmView">회원정보수정</a></li>
    ...
    padding-bottom: 10px;">
		...
		<div class="topSpotGreen">
			<div class="leftColum">
				...
				<div class="btnArea">
					<a href="/web/myproduct/productRegist"><img src="${cpath}/img/productListView/btn_saleEnroll.png" alt="판매등록"></a>
				</div>
			</div>
			...
			<div>
				...
				<ul class="bulListSqGray">
					<li>티켓베이는 안전거래를 원칙으로 운영되고 있습니다.  <br>판매 상품의 직거래로 인한 피해가 발생하지 않도록 주의 바랍니다.</li>
				</ul>
			</div>
		</div>
				...
				<form name="major" method="post">
					...
					<div class="dateCalcArea mb0">
						...
						<div class="slcDate flArea">
							<a href="#" data-val="0" class="radiusL">오늘</a>
							<a href="#" data-val="1">1주일</a>
							<a href="#" data-val="2" class="on">1개월</a>
							<a href="#" data-val="3" class="">3개월</a>
							<a href="#" data-val="4">6개월</a>
							<a href="#" data-val="5" class="radiusR">1년</a>
						</div>
						...
						<div class="calcArea flArea">
							<!-- inpCal -->
							<div class="inpCal">
								<input type="text" id="SDATE" name="SDATE" class="textInp03 range-date-from hasDatepicker" title="검색 시작일" style="width:79px" readonly=""><img class="ui-datepicker-trigger" src="" alt="달력" title="달력">
							</div>
							
							<em>~</em>
							<!-- inpCal -->
							<div class="inpCal">
								<input type="text" id="EDATE" name="EDATE" class="textInp03 range-date-to hasDatepicker" title="검색 종료일" style="width:79px" readonly=""><img class="ui-datepicker-trigger" src="" alt="달력" title="달력">
							</div>
						</div>
						
						<!-- formWrap -->
						<div class="formWrap flArea">
							<ins style="top: 0px; left: 0px;"></ins><ins class="stFormElSl01" style="width: 71px; height: 30px; padding-right: 29px; top: 0px; left: 0px; visibility: visible; opacity: 0;">전체</ins><select name="PROD_STATUS" id="PROD_STATUS" class="stFormEl01" style="width: 110px; visibility: visible; opacity: 0;">
						...
						<div class="MTB_SearchArea">
							<div class="MTB_SearchBox01">
								...
								<option value="" selected="selected">카테고리를 선택해주세요.</option>                      <option value="3882">콘서트 &gt; 더팩트 뮤직 어워즈 &gt; TMA 2022 </option></select>
								<input type="hidden" id="CATE_SEQ" name="CATE_SEQ" value="">
							</div>
							<div class="MTB_SearchBox02">
								<input type="text" id="SEARCH_VALUE" name="SEARCH_VALUE" class="input_style_basic width_292" style="" placeholder="검색어를 입력해주세요.">
							</div>
						</div>
						<!-- 202005추가 //  -->
						<!-- 2020-12-23 추가  -->
			...
			<div class="conStyle">
				...
				<div class="optionArea">
					...
					<div class="leftColum">
						<!-- formWrap -->
						<div class="formWrap">
							<label><ins style="top: 0px; left: 0px;"></ins><ins class="stFormElCh01" style="width: 14px; height: 14px; top: 0px; left: 0px; visibility: visible; opacity: 0;"></ins><input type="checkbox" class="stFormEl01 allCheck" style="visibility: visible; opacity: 0;"><span>전체선택</span></label>
						</div>
					</div>
					
					<div>
						<a href="#" id="btnProductDelete"><img src="${cpath}/img/productListView/btn_gDel.gif" alt="삭제"></a>
						<a href="/web/myproduct/productRegist"><img src="${cpath}/img/productListView/btn_bToSell.gif" alt="판매등록"></a>
					</div>
				</div>
				...
				<table class="tableStyle">
					...
					<colgroup>
						<col style="width:108px;"> <!-- 20200512수정 -->
						<col style="width: auto;">
						<col style="width:108px;">
						<col style="width:93px">
						<col style="width:88px;">
						<col style="width:80px;"> <!-- 20200512수정 -->
						<col style="width:40px;">
						<col style="width:78px;">
					</colgroup>
					<thead>
						<tr>
							<th scope="col">상품번호/<br>등록일</th>
					...
					<tbody>
						...
						<tr data-prodSeq="{{= row.PROD_SEQ}}" data-prodNum="{{= row.PRD_DISP_NO}}" data-cateSeq="{{= row.CATE_SEQ}}" data-ticketGrade="{{= row.TICKET_GRADE}}" data-ticketFloor="{{= row.TICKET_FLOOR}}" data-ticketArea="{{= row.TICKET_AREA}}">
							...
							<td>
								<span class="bePrice01"><em>{{= s.numberFormat(+row.SALE_PRICE)}}</em>원</span>
							</td>
							
							<td class="deal_type">
								{{if (+row.TRANSACTION_TYPE & 1) == 1}}
									{{if row.IMMEDIATE_YN == 'Y'}}
										<span><img src="/resources/img/pinNoManage/ico_tradeType04.gif" alt="PIN 즉시거래"></span>
									{{else}}
										<span><img src="/resources/img/common/ico_tradeType01.gif" alt="PIN거래" /></span>
									{{/if}}
								{{/if}}
								{{if (+row.TRANSACTION_TYPE & 2) == 2}}
									<span><img src="/resources/img/common/ico_tradeType03.gif" alt="배송거래" /></span>								
								{{/if}}
								{{if (+row.TRANSACTION_TYPE & 4) == 4}}
									{{if row.SITE_TICKETING_YN == 'Y'}}
										<span><img src="/resources/img/myticketing/ico_tradeType04.gif" alt="현장발권"></span>
									{{else}}
										<span><img src="/resources/img/common/ico_tradeType02.gif" alt="현장거래" /></span>	
									{{/if}}
								{{/if}}
								{{if (+row.TRANSACTION_TYPE & 16) == 16}}
									<span><img src="/resources/img/common/ico_tradeType16.gif" alt="기타거래" /></span>
								{{/if}}
							</td>
							
							<td class="mid">
								{{if (+row.COUP_TYPES & 32) == 32}}
 									<span class="date">파워존</span>
 									{{if (row.PROD_STATUS_LABEL) == "승인대기"}}
 										<span class="date colorO">(적용중)</span>
 									{{/if}}
 									{{if (row.PROD_STATUS_LABEL) == "판매중"}}
 										<span class="date colorO">({{= row.REMAIN_DATE.split("/")[0]}} 남음)</span>
 									{{/if}}
								{{/if}}
								{{if (+row.COUP_TYPES & 64) == 64}}
 									<span class="date">리스트상단노출</span>		
 									{{if (+row.COUP_TYPES & 32) == 32}}
 										<span class="date colorO">({{= row.REMAIN_DATE.split("/")[1]}} 남음)</span>
 									{{else}}
 										<span class="date colorO">({{= row.REMAIN_DATE.split("/")[0]}} 남음)</span>
 									{{/if}}
								{{/if}}
								{{if (+row.COUP_TYPES & 128) == 128}}
 									<span class="date">리스트 강조</span>
 									{{if (+row.COUP_TYPES & 96) == 96}}
 										{{if (row.PROD_STATUS_LABEL) == "승인대기"}}
 										<span class="date colorO">(적용중)</span>
 										{{/if}}
 										{{if (row.PROD_STATUS_LABEL) == "판매중"}}
 											<span class="date colorO">({{= row.REMAIN_DATE.split("/")[2]}} 남음)</span>
 										{{/if}}
 									...
 									{{/if}}
								{{/if}}
								<span><a href="#" class="btnPremiumCouponPop btn_table_sub_01">등록권 사용</a></span>
							</td>
							...
							<td class="bgG">
								...
								{{if row.PROD_STATUS == '8'}}
									<span><a href="#" class="btnSaleStop btn_table_sub_02" style="margin-bottom:3px;">판매중지</a></span>
									
										<span><a href="#" class="btnSaleModify btn_table_sub_03" data-remaincnt="{{= row.REMAIN_QTY}}" data-totalcnt="{{= row.TOTAL_QTY}}">수정하기</a></span>
									
								{{else row.PROD_STATUS == '16'}}
									<span><a href="#" class="btnReEnroll btn_table_sub_03">재등록</a></span>
								{{else row.PROD_STATUS == '64'}}
									<span class="ableDate">관리자에게 문의하세요.</span>
									<span><a href="#" class="btnInquiryPop btn_table_sub_01">1:1문의</a></span>
								{{/if}}
							</td>
						</tr>	
						{{/each}}
					    ...
					    <tr data-prodseq="5334157" data-prodnum="3882106851360" data-cateseq="3882" data-ticketgrade="A" data-ticketfloor="" data-ticketarea="1">        <td>         <!-- formWrap -->         <div class="formWrap">          <label>           <span class="formCenter">            <ins class="stFormElCh03" style="width: 16px; height: 16px; top: 0px; left: 0px;"></ins><input type="checkbox" name="PROD_SEQ" value="5334157" class="stFormEl03" data-cateseq="3882" data-ticketgrade="A" data-ticketfloor="" data-ticketarea="1" style="visibility: visible; opacity: 0;">           </span><br><br>           <div class="orderInfo"><p><a href="javascript:detail('3882106851360');">3882106851360</a></p></div><br>           <!-- <span _tmplitem="6"  class="date">2022.09.21</span> -->           <span class="date">2022.09.21</span>          </label>         </div>        </td>                <td>         <!-- tbProductInfo -->         <div class="tbProductInfo1">          <a href="javascript:detail('3882106851360');">           <em class="bPath">[콘서트 &gt; 더팩트 뮤직 어워즈 &gt; TMA 2022]</em>           <p>1구역 1열  A 1</p>           <i>                                       2022.10.08 18:30                                    </i>           <!-- <span _tmplitem="6" ></span> -->          </a>         </div>        </td>                <td>         
					    <span class="bePrice01"><em>1,000,000</em>원</span></td><td class="deal_type"><span><img src="${cpath}/img/productListView/ico_tradeType01.gif" alt="PIN거래"></span>                                                      </td>                <td class="mid">                                    <span><a href="#" class="btnPremiumCouponPop btn_table_sub_01">등록권 사용</a></span>        </td>                <td class="bgG">         <span class="colorG"><em class="fntW">1</em>/1</span>        </td>                <td class="bgG">0</td>        <td class="bgG">         <span>판매중지</span>                   <span><a href="#" class="btnReEnroll btn_table_sub_03">재등록</a></span>                 </td>       </tr></tbody>
				</table>
								
				<!-- before / next paging -->
				<div class="paging-container text-center last_paging btn_gr_02"><div class="paging_next"> <!-- btn_comm -->   <a href="#" class="nav_button" data-direction="0" data-cursor-seq="1" id="nav_fir">처음</a>   <a href="#" class="nav_button" data-direction="3" data-cursor-seq="5334157" id="nav_pre">이전</a>   <a href="#" class="nav_button" data-direction="2" data-cursor-seq="5334157" id="nav_nex">다음</a>   <a href="#" class="nav_button" data-direction="1" data-cursor-seq="1" id="nav_las">마지막</a>  </div></div>
				
				<div style="text-align:right;">
					<a href="#" id="btnExcelDownload"><img src="${cpath}/img/productListView/btn_excel_down.gif" alt="EXCEL 다운로드"></a>
				</div>
			</div>
		</div>
		<!-- //boxStyle -->
